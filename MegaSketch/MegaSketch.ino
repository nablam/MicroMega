...
void loop() {
	//_currentValue = s1.ReadMicroseconds();
	currentMillis = millis();
	if (currentMillis - previousMillis >= loopCycle) {
...
//
////ServoII* FL0_p36 = new ServoII(ServoII::ServoNames::BL0, 36, 1100, 2000);
////ServoII* FL1_p38 = new ServoII(ServoII::ServoNames::BL1, 38, 1140, 2060);
//ServoII FL1_p38;// = new ServoII(ServoII::ServoNames::BL1, 38, 1140, 2060);
//ServoII* FL2_p40 = new ServoII(ServoII::ServoNames::BL2, 40, 1350, 2350);
...
//		FL1_p38.write(tempangle);
//		FL2_p40->write(tempangle);
//		Serial.println(tempangle);
//		delay(tempDelay);
//
//		tempangle = 60;
